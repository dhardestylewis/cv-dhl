...
%  \clearpage
  ...
  \subsection{\textsc{Research}}
    \cventry{2021~Aug. -- Present}{Engineering scientist associate}{Texas Advanced Computing Center}{Austin,~United~States}{}{%  \newline{}
      ...
      \begin{itemize}
	\item Principal developer of the \href{highest quality terrain data in Texas}{http://agis-sec-green2.csr.utexas.edu/resources/lidar\_elevation.html}
...
%%%     UNITED STATES
  ...
  \section{\textsc{Academic projects}}
    \cvitem{2022~June -- Present}{Advanced compound flood hazard assessment science  \newline{}
      {\small Partner with US Army Corps of Engineers to statistically model flood hazards in Texas's coastal region}}
    \cvitem{2021~Oct. -- Present}{Texas Disaster Information System (\textsc{TDIS})  \newline{}
    ...
    \cvitem{2020~Nov. -- Present}{Networks for Hazard Preparedness and Response  \newline{}
