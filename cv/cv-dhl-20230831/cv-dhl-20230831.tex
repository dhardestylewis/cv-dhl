...
%%%-----     letter     -----
%%% recipient data
%  \recipient{Recipient}{Research Computing Center\\University of Chicago\\6054 S Drexel Ave\\Chicago IL 60637\\United States}
%  \date{January 7, 2022}
...
%  \clearpage
  \section{\textsc{Education}}
    \cventry{expected 2026~May}{M.S., Urban Planning}{Columbia University}{New York City,~United~States}{}{}%Topology I
  ...
  \subsection{\textsc{Research}}
    \cventry{2021~Aug. -- 2023~Aug.}{Engineering scientist associate}{Texas Advanced Computing Center}{Austin,~United~States}{}{%  \newline{}
      ...
      \begin{itemize}
        \item Principal developer of the highest quality terrain data in Texas
        \item Acquired the thumbs-up for this data from top State hydrologists and eminent UT engineers
	\item Vigorously advanced University tech commercialization of this data, reasonably valued at \$2M/customer
	\item Extended our reach with novel advertising that has activated dozens of new research relations across the University and private sector
	\item Achieved a 14\% click-through rate (CTR) with key audiences
        \item Innovated an open-source licensing strategy for this data that is novel to the engineering community and protects University data producers from liability due to death or injury
	\item Cemented TACC's relationship with the US Army Corps of Engineers through key scaling results
	\item Teach undergrads thru post-docs from UT Austin, University of Cambridge, \& Texas A\&M - Galveston
      \end{itemize}}
...
%%%     UNITED STATES
    \cventry{2018~Feb. -- 2021~July}{Research engineering / scientist associate I}{Texas Advanced Computing Center}{Austin,~United~States}{}{%  \newline{}
      ...
      \begin{itemize}
        ...
        \item Collaborated to unify data of Texas's water resources for integrated hydrology modellers
      \end{itemize}}
%%%     The Texas Institute for Discovery Education in Science of my
%%%     university's College of Natural Sciences funded, through a generous
%%%     fellowship, my summer's work at the supercomputing centre, TACC. By
...
%%%    \cventry{2019~May -- Present}{Member-owner}{Hardy Cooperative}{Austin,~United~States}{}{  \newline{}
  ...
  \section{\textsc{Technology~skills}}
    \cvdoubleitem{Programming Languages}{\raggedright Fortran, Perl, Python, Bash shell, PL/pgsql}{Operating Systems}{\raggedright \textsc{gnu}/Linux, mac\textsc{os}, Windows}
    \cvdoubleitem{Virtualization}{\raggedright Docker, Singularity, chroot}{Database management systems}{\raggedright PostgreSQL}
    \cvdoubleitem{Scientific models}{\raggedright \textsc{modflow}, \textsc{hand}, \textsc{hec-ras}}{Libraries}{\raggedright \textsc{gdal/ogr}, NumPy, GeoPandas, RasterIO, Matplotlib, Plotly, Dash}
    \cvdoubleitem{Cloud}{\raggedright \textsc{AWS}, Azure}{Source code management}{\raggedright Git, SVN}
