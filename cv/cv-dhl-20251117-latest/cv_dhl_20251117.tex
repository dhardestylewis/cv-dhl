...
\begin{document}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
        \item Architected and deployed a nationwide, neighborhood-level score-based diffusion forecasting model, achieving a 7.3\% 1-year forecast error (matching Zillow's 7.3\% 0-year benchmark) and maintaining a 35.6\% median absolute error at a 4-year horizon.
        ...
        \item Developed rigorous predictive validation (optimizing for PIT uniformity, interval coverage, and sharpness) to strictly validate forecast reliability prior to web delivery.
