...
%% Themes
  ...
  \hbadness=99999
  % Force section and item titles to red (robust for moderncv >=2.4.1)
  % \usepackage{xcolor}
  % \definecolor{myred}{rgb}{0.95,0.20,0.20}
  % Patch section title color (moderncv >=2.4.1)
  \makeatletter
...
\begin{document}
  ...
  % Injected moderncvcolorred.sty color definitions
  \definecolor{color0}{rgb}{0,0,0} % black
  \definecolor{color1}{rgb}{0,0,0} % red
