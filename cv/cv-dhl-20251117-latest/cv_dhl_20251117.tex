...
\begin{document}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
        \item Architected and deployed a nationwide, neighborhood-level score-based diffusion forecasting model, achieving an 8\% one-year forecast error that outperforms Zillow's 8.4\% benchmark, and maintaining a highly stable 25\% MdAE at a 4-year horizon.
