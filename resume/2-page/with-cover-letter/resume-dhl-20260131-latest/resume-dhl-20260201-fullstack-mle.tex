...
\vspace{0.6em}
  ...
  \cvitem{8~years}{\textbf{Technical Leadership}: Drive cross-functional execution via specs and governance (RFPs/MOUs, RFCs, milestones, acceptance criteria); mentor engineers through design/code reviews and instruction}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
      \item Engineered a 0.5~m statewide seamless Texas DEM mosaic via nearest-neighbor stitching across 70+ state, federal, \& local sources.
      \item Developed the web distribution platform end-to-end (data pipeline, tiling, hosting, delivery UX) for engineering \& planning use cases.
    ...
    \begin{itemize}
        ...
        \item Led inter-agency RFP and MOU development with state and federal partners (e.g., USACE, Texas GLO), translating technical requirements into scope, milestones, and acceptance criteria enabling the \$40M resiliency platform.
        \item Scaled climate and flood models on supercomputers, executing million-node distributed jobs while managing multi-million-dollar compute budgets and federal partnerships (NOAA, NSF, USCE, GLO).
        ...
        \item Developed efficient methods to produce high-resolution (1m) flood maps from National Water Model outputs for Texas Emergency Management (\href{https://storymaps.arcgis.com/stories/6227f24d6c5047f883d5c3497241f299}{Real-Time Inundation Mapping}).
    ...
    \begin{itemize}
        ...
        \item Received research recognition from AAAI Pres. Yolanda Gil during her \href{https://youtu.be/3Spk_UOHNxA?t=2377}{farewell address} for contributions to automated scientific modeling.
  ...
  \section{\textsc{Activities}}
    \cvdoubleitem{Sailing}{Transatlantic; volunteer Atlantic SAR of the \href{https://en.wikipedia.org/wiki/Cheeki_Rafiki}{Cheeki Rafiki}}{Bikepacking}{US West \& East Coasts}
