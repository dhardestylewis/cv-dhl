...
\vspace{0.6em}
  ...
  \cvitem{8~years}{\textbf{Technical Leadership}: Drive cross-functional and external execution through written specs and governance (RFCs, RFPs/MOUs, milestones, acceptance criteria); mentor engineers through design reviews, code reviews, and instruction}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
        ...
        \item Led inter-agency RFP and MOU development with state and federal partners (e.g., USACE, Texas GLO), translating technical requirements into scope, milestones, and acceptance criteria that enabled delivery of the \$40M resiliency platform.
  ...
  \section{\textsc{Activities}}
    \cvdoubleitem{Transatlantic Sailing}{Volunteer offshore SAR of the \href{https://en.wikipedia.org/wiki/Cheeki_Rafiki}{Cheeki Rafiki}}{Bikepacking}{US West \& East Coasts}
