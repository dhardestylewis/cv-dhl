...
\vspace{0.6em}
  ...
  \cvitem{10~years}{\textbf{Geospatial AI}: Build spatiotemporal pipelines and models for risk, planning, and hazard decision-support use cases}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
        ...
        \item Led inter-agency RFP and MOU development with state and federal partners incl. USACE, Texas GLO, translating technical requirements into scope, milestones, and acceptance criteria enabling the \$40M resiliency platform.
  ...
  \section{\textsc{Key Projects}}
    \cvitem{DeepSeek}{Math benchmarking and finetuning of Deepseek's GRPO algorithm}
