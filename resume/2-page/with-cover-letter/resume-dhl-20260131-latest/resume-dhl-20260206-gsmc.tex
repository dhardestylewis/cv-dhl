...
I have shipped end to end systems that match your mission. At Homecastr, I built and deployed interactive uncertainty visualization using fan charts for a diffusion based forecasting system, backed by leakage safe expanding window evaluation and delivered through a live web prototype at \href{https://houston-price-prediction.vercel.app}{houston-price-prediction.vercel.app}. The interface required careful design around uncertainty and model selection tradeoffs, and I am extending it with explanation and evidence views that let a user inspect inputs, sensitivity, and failure modes. That work draws on my industry sponsored research at Columbia, where I derived tractable per feature attribution methods designed for stability across mutual fund market regimes and used them to debug regime dependent model behavior.
