...
\vspace{0.6em}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
        ...
        \item Shipped a Houston diffusion-based forecasting system with fan charts; achieved as low as $\sim$8\% annualized compounding error, balancing design choices of error vs.\ trajectory realism, delivered via production web UI: \href{https://houston-price-prediction.vercel.app/}{houston-price-prediction.vercel.app}
