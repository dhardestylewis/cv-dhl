...
\vspace{0.6em}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
        ...
        \item Shipped fan charts ($\sim$8\% annualized error, Houston); training on Modal, artifacts on GCS. \textbf{Teacher/Student distillation} for national scaling (MS Buildings, ACS, OSM): \href{https://www.homecastr.com/}{homecastr.com}
