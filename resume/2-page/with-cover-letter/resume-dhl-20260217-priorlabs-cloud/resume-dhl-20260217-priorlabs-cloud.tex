...
\vspace{0.6em}
  ...
  \cvitem{Infrastructure}{Linux/Unix; Bash; Git; Docker; Kubernetes; Terraform; Ray; Spark; Dask; Airflow; CI/CD; monitoring \& observability}
  ...
  \subsection{\textsc{Teaching}}
    ...
    \begin{itemize}
        \item Helped design and teach graduate-level courses: \emph{Machine Learning for the Geosciences} for Petrobras engineers, \emph{Intelligent Systems for the Geosciences}, and \emph{Scientific Computation}, including C++, CUDA, HPC, \& optimization.
    \end{itemize}}
