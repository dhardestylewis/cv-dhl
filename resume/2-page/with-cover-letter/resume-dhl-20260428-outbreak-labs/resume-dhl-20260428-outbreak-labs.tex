...
\vspace{0.6em}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
      \item Architected a nationwide tract-level diffusion forecasting model, \textbf{beating Zillow's 8.4\% one-year error benchmark at 8\%} and maintaining a \textbf{stable 25\% MdAE over a 4-year horizon}.
