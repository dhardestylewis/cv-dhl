...
\vspace{0.6em}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
      \item Architected a nationwide neighborhood-level diffusion forecasting model, \textbf{beating Zillow's 8.4\% one-year error benchmark at 8\%} and maintaining a \textbf{stable 25\% MdAE over a 4-year horizon}.
      ...
      \item Developed a probabilistic evaluation suite optimizing PIT uniformity, interval coverage, and sharpness to \textbf{rigorously validate forecast reliability} before production delivery.
