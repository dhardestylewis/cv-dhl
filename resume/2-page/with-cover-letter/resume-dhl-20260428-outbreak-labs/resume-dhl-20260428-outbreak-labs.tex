...
%% Margins
  \usepackage[left=0.6in,right=0.6in,top=0.3in,bottom=1.0in]{geometry}
...
%% Data
  ...
  \title{\large Geospatial ML Scientist -- earth observation, distributed infrastructure, computer vision}
...
%%%-----     cover letter     -----
  \recipient{Hiring Team}{Outbreak Labs\\London, UK}
  \date{April 28, 2026}
...
I am writing to express my interest in the Senior Geospatial Machine Learning Scientist position at Outbreak Labs. Having built spatial ML platforms from 0 to 1 - most recently architecting nationwide diffusion-based forecasting models at Homecastr and engineering a statewide high-resolution elevation platform at Summit Geospatial - I am now seeking to bring that execution speed to a deeply technical, mission-driven team. Your goal to mitigate agricultural pests perfectly aligns with my background in Earth observation.

Prior to my current ventures, I spent five years as a Senior Data Scientist at the Texas Advanced Computing Center (TACC). There, I gained firsthand experience with the complexities of agricultural and environmental modeling by competing in the DARPA World Modelers program to forecast food security in East Africa - work that led to joint publications on intelligent systems with the former president of AAAI. I also led the data pipelines for the \$40M Texas Disaster Information System, scaling models across leadership-class supercomputers and contributing fundamental geospatial research that supported the 2022 EGU Bagnold Medal in geomorphology.

My technical stack spans both modern generative AI workflows and the core geospatial libraries you require, including Python, PyTorch, TensorFlow, GeoPandas, Rasterio, GDAL, and xarray. As an early-stage founder, I thrive in fast-paced environments where I can take ownership of both the research direction and production engineering. I am excited by the opportunity to apply my expertise to build data-driven strategies that protect global agricultural production.

I would welcome the opportunity to discuss how my background can contribute to Outbreak Labs' mission. Please note that regarding work authorization, I am eligible to independently secure the UK Global Talent Visa (Tech Nation) without employer sponsorship. To accommodate a fast-moving start date, I am also open to beginning the role as a US-based independent contractor while my visa processes for relocation.
