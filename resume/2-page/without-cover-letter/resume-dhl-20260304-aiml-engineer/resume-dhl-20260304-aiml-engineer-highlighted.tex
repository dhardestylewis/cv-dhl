...
%% Data
  ...
  \title{\large \colorbox{yellow}{AI/ML Engineer -- LLM API integration, Python backend, cloud-native AI systems}}
...
\small\raggedright
\colorbox{yellow}{\parbox{\dimexpr\textwidth-2\fboxsep}{Specializing in scalable Python backends integrating LLM APIs (OpenAI, Claude, Gemini) with cloud-native AI systems. Delivered production ML across tabular, geospatial, and time-series workloads at supercomputer scale.}}
\end{minipage}
\vspace{0.6em}
  ...
  \cvitem{Modeling}{PyTorch; TensorFlow; scikit-learn; \colorbox{yellow}{Hugging Face} Transformers; LoRA/QLoRA/PEFT}
  \cvitem{\colorbox{yellow}{LLM}}{\colorbox{yellow}{OpenAI API; Claude API; Gemini API}; embeddings; RAG; LangChain; LangGraph; DSPy; FAISS}
  \cvitem{\colorbox{yellow}{Data}}{SQL; Pandas; Polars; PyArrow; Parquet; Postgres; \colorbox{yellow}{Supabase}; BigQuery; Redis; \colorbox{yellow}{MongoDB}; Elasticsearch}
  \cvitem{Infrastructure}{Linux; Git; Docker; Kubernetes; \colorbox{yellow}{Modal}; \colorbox{yellow}{Vercel}; Terraform; Ray; Dask; Airflow; CI/CD}
  \cvitem{Additional}{CUDA; C++; TypeScript; React; \colorbox{yellow}{REST/async}; \colorbox{yellow}{GitHub Copilot}; \colorbox{yellow}{ChatGPT API}; \colorbox{yellow}{v0}}
