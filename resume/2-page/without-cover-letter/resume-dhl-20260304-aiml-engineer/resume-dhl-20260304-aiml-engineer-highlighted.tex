...
\vspace{0.6em}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
        \item Built an NYC VAE model (12\% error vs.\ Zillow's 8.4\%); evolved to a \hl{v11 score-based diffusion model} (inducing tokens, per-horizon loss, DDIM). Eval via \textbf{Calibration Packet}: PIT histograms, coverage, sharpness.
