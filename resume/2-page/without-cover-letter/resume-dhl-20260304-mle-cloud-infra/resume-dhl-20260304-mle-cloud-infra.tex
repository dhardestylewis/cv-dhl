...
%% Data
  ...
  \title{\large ML Engineer -- distributed training infrastructure, cloud-scale ML systems, tabular data}
...
\small\raggedright
Specializing in scalable cloud infrastructure for ML training and serving. Delivered production systems across tabular, geospatial, and time-series workloads at supercomputer scale.
\end{minipage}
\vspace{0.6em}
  ...
  \cvitem{Data stack}{Python; SQL; Pandas; Polars; PyArrow; Parquet; Postgres; BigQuery; Redis; Elasticsearch}
  \cvitem{Infrastructure}{Linux; Git; Docker; Kubernetes; Modal; GCS; Terraform; Triton; Ray; Dask; Airflow; CI/CD; monitoring \& observability}
