...
\vspace{0.6em}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
      \item Advised on and architected the backend agentic workflow for BOM parsing and tariff simulation, leading development through the end of summer 2025.
      ...
      \item Executed customer discovery with ScoutyAI and Columbia economists, and secured early market validation by presenting the prototype to KPMG.
    \end{itemize}}
