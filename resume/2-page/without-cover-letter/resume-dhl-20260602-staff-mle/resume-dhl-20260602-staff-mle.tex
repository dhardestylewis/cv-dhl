...
\vspace{0.6em}
  ...
  \subsection{\textsc{Professional}}
    \cventry{Jun.~2026 -- Present}{Member Resident}{\href{https://www.southparkcommons.com/}{South Park Commons}}{New York, NY}{}{
    Selective technology community for founders, researchers, and builders in the -1~to~0 phase.
    \begin{itemize}
      \item Exploring spatiotemporal foundation models and causal inference for infrastructure decision-support, with a focus on AI data center feasibility and physical risk quantification.
    \end{itemize}}
