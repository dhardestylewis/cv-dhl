...
\vspace{0.6em}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
        \item Deployed a semi-supervised VAE on \textbf{tabular property records} (tax, sales, permits) to handle \textbf{sparsity and noise} in structured data; achieved 12\% holdout error (vs.\ Zillow's 8.4\% internal apples-to-apples).
