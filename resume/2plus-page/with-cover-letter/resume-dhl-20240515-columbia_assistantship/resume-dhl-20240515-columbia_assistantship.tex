...
%%%-----     letter     -----
%%% recipient data
  \recipient{Recipient}{Laura Kurgan \& Kellen Funk\\Columbia University\\New York NY 10027\\United States}
  \date{May 15, 2024}
  \opening{Dear Professor Kurgan and Professor Funk,}
  \closing{Sincerely,}
  \enclosure[Attached]{curriculum vit\ae{}}
  \makelettertitle
%
I am writing to express my strong interest in the Graduate Research Assistant position working on the Cities of Bail project in collaboration with Columbia Law School. With my extensive background in geospatial analysis, data visualization, and web development, I believe I am uniquely qualified to make valuable contributions to this important project examining the impact of bail bonds on urban communities.

I could mention how I've headed up and completed one of the lead moonshot projects for a \$40M disaster resiliency initiative in Texas, taking on multiple hats to wrangle the data and code on one of the largest supercomputers in the world and provide the first seamless topographical dataset produced for an entire state independently of the USGS, but you don't need that in this cover letter. \textbf{What you need is this:}

\section*{Key Strengths and Areas for Improvement}
After reviewing your project, I have identified several strengths and critical areas for improvement to enhance efficiency, maintainability, and scalability.

\textbf{Strengths:}
\begin{itemize}
	\item \textit{Effective Use of Mapbox:} Excellent implementation of interactive maps using Mapbox GL JS.
	\item \textit{Comprehensive Data Layers:} Robust integration of various demographic and economic data layers.
\end{itemize}

\textbf{Critical Areas for Improvement:}
\begin{itemize}
	\item \textit{Performance Optimization:} To improve performance, I recommend optimizing the GeoJSON files by simplifying geometries or utilizing vector tiles. This will ensure faster loading times and enhanced user experience.
	\item \textit{Adopting a Modern Framework:} Migrating the codebase to a modern framework like React or Vue would enable faster development cycles, better state management, and a more maintainable component-based architecture. This approach will facilitate rapid prototyping and iterative improvements.
	\item \textit{Separation of Data and Presentation:} Decoupling the data from the presentation layer by storing data configurations in separate files and loading them dynamically will greatly enhance the maintainability and scalability of the application.
	\item \textit{Dynamic Layer Management:} Refactoring the code to use functions or loops for adding layers will reduce redundancy and improve code clarity. Implementing dynamic layer management will make the codebase more efficient and easier to extend.
\end{itemize}

\section*{Proposed Next Steps}
\begin{itemize}
	\item Adopt React or Vue and build UI components to dynamically load and manage data layers.
	\item Optimize data handling by refactoring loading and leveraging vector tiles for large datasets.
	\item Separate data configurations into files and load them dynamically.
	\item Standardize naming conventions and refactor code into reusable functions. Implement dynamic layer management.
\end{itemize}

The current approach provides a strong foundation, and by addressing these critical areas, you can significantly enhance the performance, scalability, and maintainability of your project. I would be excited to bring my technical skills and creative problem solving to help drive this project forward. The combination of geospatial analysis and critical examination of the justice system aligns closely with my own research interests.

Please let me know if you would like any additional information. I look forward to the opportunity to discuss further how I could contribute to the Cities of Bail project and the mission of the Center for Spatial Research.

Thank you for your consideration.

If you are interested, feel free to reach out: (713) 371-7875.

Oh and if you are interested in that topographical data:
\href{http://summitgeospatial.com}{summitgeospatial.com}
...
%    \cventry{expected 2025~May}{M.S., Urban Planning}{Columbia University}{New York City,~United~States}{}{}%Topology I
    \cventry{2025~ant.}{M.S., Urban~Planning}{Columbia University}{New~York~City,~United~States}{}{}%Topology I
%    \cventry{expected 2025~May}{M.S., Urban Planning}{Columbia University}{New York City,~United~States}{}{}%Topology I
...
%    \cvitem{2016~Apr.}{\emph{Hardesty~Lewis,~D.} "On smoothness and Poisson's Equation". {\small Presented at the 2016 annual DRP Undergraduate Project Symposium at the University of Texas at Austin.}}
  \section{\textsc{Technology~skills}}
    \cvdoubleitem{Languages}{\raggedright Python, Bash shell, Fortran, Perl}{\textsc{gis}}{\raggedright Arc\textsc{gis}, \textsc{qgis}, Post\textsc{gis}, GeoServer, GeoNode}
    \cvdoubleitem{Virtualization}{\raggedright Docker}{Databases}{\raggedright Postgre\textsc{sql}, \textsc{sql}}
    \cvdoubleitem{Scientific models}{\raggedright \textsc{hand}, \textsc{hec-ras}}{Libraries}{\raggedright \textsc{gdal/ogr}, \textsc{geos}, NumPy, GeoPandas, RasterIO, Matplotlib, Plotly, Dash, Vue, D3, React, Vue, Mapbox, GeoJSON}
    \cvdoubleitem{Cloud}{\raggedright \textsc{aws}, Azure, \textsc{gcp}}{Source code management}{\raggedright Git}
%    \cvdoubleitem{Computer Algebra Systems}{\raggedright Maxima, Mathematica}{Word Processors}{\raggedright \LaTeX, LibreOffice}
  \section{\textsc{Review committees}}
    \cvitem{2023~Mar. -- 2023~Apr.}{Frontera Fellows applications  \newline{}
      {\small Determined the most qualified doctoral fellows' projects on one of the largest supercomputers in the world}}
    \cvitem{2022 Aug.}{TACC's Frontera Pathways \& Large-Scale Community Partnerships applications  \newline{}
      {\small Reviewer approving/denying millions of dollars in computing resources to multimillion-dollar projects}}
  ...
  \section{\textsc{Academic projects}}
    \cvitem{2024~Apr.--Present}{\textbf{Massive Tracking} \newline{}
      {\small Developed the most comprehensive open-source call data record to mobility metric. \textit{Preparing results for publication.}}}
    \cvitem{2024~Apr.--Present}{\textbf{Dallas Mortgage Analysis} \newline{}
      {\small Implemented scraper for parcel-level, de-anonymized mortgage data for Dallas, Texas. This data tracks closely with actual sales data, previously unavailable at the individual home level in Texas, and is more accurate than Zillow. \textit{Seeking research collaborators for this project.}}}
    \cvitem{2024~Apr.--Present}{\textbf{Geography of NIMBYism in Texas} \newline{}
      {\small Scoping out costs and procedures to obtain protest letter data opposing zoning changes in major Texas cities via FOIA requests. Data includes addresses of non-government protestors within 200 ft of proposed changes. \textit{Seeking research collaborators for this project.}}}
