...
%% Themes
  ...
  \newcommand{\newedit}[1]{\textcolor{blue}{\textbf{#1}}}
...
%% Data
  ...
  \title{\large \newedit{Machine Learning SWE Lead} \textbullet{} \newedit{GCP, MLOps, geospatial ML, observability, distributed systems}}
...
\begin{document}
  ...
  \recipient{\newedit{Gabe Schook and the Bellwether Hiring Team}}{\newedit{X, The Moonshot Factory\\Mountain View, CA}}
  \date{\today}
  \opening{\newedit{Dear Gabe and the Bellwether team,}}
  \closing{Sincerely,}
  \enclosure[Attached]{resume}
  \makelettertitle

I am writing to express my strong interest in the \newedit{Machine Learning Software Engineering Lead} role on Project Bellwether. Bellwether's focus on turning geospatial and machine learning systems into reliable, customer-facing products for severe weather and climate risk is closely aligned with the work I have led throughout my career.

At the \newedit{Texas Advanced Computing Center (TACC)}, where I served as a \newedit{Senior Data Scientist and Technical Lead}, I helped develop real-time flood inundation models and disaster-resilience tools in collaboration with state and federal partners. In that setting, model reliability directly influenced planning and emergency-response decisions. That experience shaped how I build machine learning systems: \newedit{with strong data foundations, rigorous evaluation, careful deployment, and clear operational accountability}.

More recently, as \newedit{Founder and ML Architect at Homecastr}, I built an end-to-end experimentation, training, evaluation, inference, and monitoring stack for large-scale spatial forecasting. I designed the modeling and validation infrastructure from scratch, including probabilistic evaluation workflows intended to ensure forecast reliability before production release. I have led work across data systems, model development, deployment, API-backed delivery, and production observability, with \newedit{hands-on experience operating ML infrastructure on Google Cloud and related tooling}.

What particularly attracts me to Bellwether is the opportunity to help guide production machine learning for real-world geospatial products in a small, highly collaborative team. I am comfortable moving between architecture, modeling, infrastructure, debugging, and stakeholder communication, and I value the combination of technical depth, execution speed, and product ownership that this role requires.

I would be excited to bring my background in \newedit{production geospatial ML, high-stakes weather and hazard modeling, and end-to-end ML systems leadership} to Bellwether. Thank you for your time and consideration. I would welcome the opportunity to discuss how I could contribute to the team.
...
\vspace{0.6em}
  ...
  \cvitem{\newedit{10~years}}{\newedit{\textbf{Production Geospatial ML}: Earth observation, spatiotemporal risk modeling, geospatial ETL, and decision-support systems for hazard and planning workflows.}}
  ...
  \cvitem{Modeling}{PyTorch; TensorFlow; scikit-learn; Transformers; LoRA/QLoRA/PEFT; \newedit{Ray; Spark; Dask}}
  \cvitem{LLM apps}{embeddings; RAG; LangChain; LangGraph; DSPy; FAISS; \newedit{Elasticsearch}}
  \cvitem{Data stack}{Python; SQL; Pandas; Polars; PyArrow; Parquet; Postgres; PostGIS; Redis; Supabase}
  \cvitem{Infrastructure}{\newedit{Linux}; Docker; Kubernetes; Modal; \newedit{Google Cloud Platform (GCP / GCE / GCS)}; Airflow; CI/CD}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
      \item Architected a nationwide neighborhood-level diffusion forecasting model, \newedit{delivering highly-calibrated probabilistic forecasts} and maintaining a \textbf{stable 25\% MdAE over a 4-year horizon}.
      \item \textcolor{links}{\textbf{Engineered architecture incorporating spatial inducing tokens, per-horizon loss normalization, and DDIM sampling to balance predictive precision with calibrated price trajectories.}}
      \item \textcolor{links}{\textbf{Developed a probabilistic evaluation suite optimizing interval coverage and sharpness to rigorously validate forecast reliability before production delivery.}}
      \item \textcolor{links}{\textbf{Owned the \textbf{end-to-end production ML stack} from ingestion, training, evaluation, and inference through API-backed real-time delivery and observability.}}
      \item \textcolor{links}{\textbf{Refined product strategy through direct feedback from venture partners (a16z, MetaProp, Forum Ventures), enterprise leaders (Mapbox, HR\&A), and end-users.}}
    \end{itemize}}
    ...
    \newedit{AI trade compliance platform for manufacturers, enabling automated BOM retrieval and policy scenario simulation.}
    \begin{itemize}
      \item \textcolor{links}{\textbf{\textbf{Architected an agentic RAG workflow} (Airflow, Elasticsearch, FastAPI) and \textbf{conversational AI interface} for instant BOM retrieval, tariff simulation, and compliance alerting.}}
