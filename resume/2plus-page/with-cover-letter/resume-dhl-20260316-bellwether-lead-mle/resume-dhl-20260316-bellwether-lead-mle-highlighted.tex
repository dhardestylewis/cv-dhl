...
\vspace{0.6em}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
      ...
      \item \textcolor{links}{\textbf{Developed predictive validation optimizing interval coverage and sharpness to rigorously validate forecast reliability before production delivery.}}
