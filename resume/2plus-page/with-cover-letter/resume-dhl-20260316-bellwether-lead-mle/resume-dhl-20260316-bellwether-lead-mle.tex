...
\vspace{0.6em}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
      ...
      \item Developed predictive validation optimizing interval coverage and sharpness to \textbf{rigorously validate forecast reliability} before production delivery.
