...
%% Data
  ...
  \title{\large Machine Learning SWE Lead \textbullet{} GCP, MLOps, geospatial ML, observability, distributed systems}
...
\begin{document}
  ...
  \recipient{Gabe Schook and the Bellwether Hiring Team}{X, The Moonshot Factory\\Mountain View, CA}
  \date{\today}
  \opening{Dear Gabe and the Bellwether team,}
  \closing{Sincerely,}
  \makelettertitle

I am writing to express my strong interest in the Machine Learning Software Engineering Lead role on Project Bellwether. Bellwether's focus on turning geospatial and machine learning systems into reliable, customer-facing products for severe weather and climate risk is closely aligned with the work I have led throughout my career.

At the Texas Advanced Computing Center (TACC), where I served as a Senior Data Scientist and Technical Lead, I helped develop real-time flood inundation models and disaster-resilience tools in collaboration with state and federal partners. In that setting, model reliability directly influenced planning and emergency-response decisions. That experience shaped how I build machine learning systems: with strong data foundations, rigorous evaluation, careful deployment, and clear operational accountability.

More recently, as Founder and ML Architect at Homecastr, I built an end-to-end experimentation, training, evaluation, inference, and monitoring stack for large-scale spatial forecasting. I designed the modeling and validation infrastructure from scratch, including probabilistic evaluation workflows intended to ensure forecast reliability before production release. I have led work across data systems, model development, deployment, API-backed delivery, and production observability, with hands-on experience operating ML infrastructure on Google Cloud and related tooling.
...
I would be excited to bring my background in production geospatial ML, high-stakes weather and hazard modeling, and end-to-end ML systems leadership to Bellwether. Thank you for your time and consideration. I would welcome the opportunity to discuss how I could contribute to the team.
...
\vspace{0.6em}
  ...
  \cvitem{10~years}{\textbf{Production Geospatial ML}: Earth observation, spatiotemporal risk modeling, geospatial ETL, and decision-support systems for hazard and planning workflows.}
  ...
  \cvitem{Modeling}{PyTorch; TensorFlow; scikit-learn; Transformers; LoRA/QLoRA/PEFT; Ray; Spark; Dask}
  \cvitem{LLM apps}{embeddings; RAG; LangChain; LangGraph; DSPy; FAISS; Elasticsearch}
  \cvitem{Data stack}{Python; SQL; Pandas; Polars; PyArrow; Parquet; Postgres; PostGIS; Redis; Supabase}
  \cvitem{Infrastructure}{Linux; Docker; Kubernetes; Modal; Google Cloud Platform (GCP / GCE / GCS); Airflow; CI/CD}
  \cvitem{Additional}{CUDA; C++; TypeScript; React; Bash; Git}
  ...
  \subsection{\textsc{Professional}}
    ...
    \begin{itemize}
      \item Architected a nationwide neighborhood-level diffusion forecasting model, delivering highly-calibrated probabilistic forecasts and maintaining a \textbf{stable 25\% MdAE over a 4-year horizon}.
      ...
      \item Developed a probabilistic evaluation suite optimizing interval coverage and sharpness to \textbf{rigorously validate forecast reliability} before production delivery.
      \item Owned the \textbf{end-to-end production ML stack} from ingestion, training, evaluation, and inference through API-backed real-time delivery and observability.
      \item Refined product strategy through direct feedback from venture partners (a16z, MetaProp, Forum Ventures), enterprise leaders (Mapbox, HR\&A), and end-users.
    \end{itemize}}
    ...
    AI trade compliance platform for manufacturers, enabling automated BOM retrieval and policy scenario simulation.
    \begin{itemize}
      \item \textbf{Architected an agentic RAG workflow} (Airflow, Elasticsearch, FastAPI) and \textbf{conversational AI interface} for instant BOM retrieval, tariff simulation, and compliance alerting.
